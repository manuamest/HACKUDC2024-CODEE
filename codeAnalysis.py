...
def run_codee_analysis():
    try:
        ...
        output = subprocess.check_output("./codee-2024.1.1-linux-x86_64/bin/pwreport --accept-eula --config compile_commands.json mbedtls/programs/fuzz/*.c --json", shell=True)
